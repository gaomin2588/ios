...
- (void)setData{
    [self addText:@"TextViewExamplesMenu" detailText:@"TextViewExamplesMenu demo" className:@"TextViewExampleMenu"];
    [self addText:@"TextFieldExamplesMenu" detailText:@"TextFieldExamplesMenu demo" className:@"TextFieldExampleMenu"];
}
