...
#import "TextViewExampleMenu.h"
#import "iOSExampleModel.h"

@interface TextViewExampleMenu ()

@property (nonatomic, strong) NSMutableArray *dataSource;

@end

@implementation TextViewExampleMenu
...
- (void)setData{
    [self addText:@"TextViewCategoryExample" detailText:@"TextViewCategoryExample demo" className:@"TextViewCategoryExample"];
}
