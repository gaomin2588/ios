...
#import "TextFieldExampleMenu.h"
#import "iOSExampleModel.h"

@interface TextFieldExampleMenu ()

@property (nonatomic, strong) NSMutableArray *dataSource;

@end

@implementation TextFieldExampleMenu
...
- (void)setData{
    [self addText:@"TextViewCategory" detailText:@"TextViewCategorydemo" className:@"TextViewCategoryExample"];
}
