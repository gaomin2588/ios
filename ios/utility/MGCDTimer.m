...
//+ (MGCDTimer *)timerWithTimeInterval:(NSTimeInterval)interval block:(void (^)(MGCDTimer *))block repeats:(BOOL)repeats{
//    MGCDTimer *timer = [MGCDTimer timerWithTimeInterval:interval target:self selector:@selector(timer:block:) repeats:repeats];
//    
//    return timer;
//}
//- (void)timer:(MGCDTimer *)timer block:(void (^)(MGCDTimer *timer))block{
//    if (block) {
//        block(timer);
//    }
//}
